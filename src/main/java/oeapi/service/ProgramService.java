...
import oeapi.controller.oeapiProgramMapper;
...
public class ProgramService extends oeapiEndpointDTOService<Program, ProgramRepository, ProgramDTO> implements oeapiRelatedObjServiceInterface<Program>, oeapiRelationalModelInterface<Program> {
    ...
    public void initializeMapper() {
        super.initializeMapper(Program.class, ProgramDTO.class, enumService, Arrays.asList("level"));
        super.setMapper(new oeapiProgramMapper(enumService, Arrays.asList("level"), fieldsOfStudyRepository));
    }
