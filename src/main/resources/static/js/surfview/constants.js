...
Constants.tabs = {
    ...
    academicSessions: {
        ...
        idField: 'academicSessionId',
        detailEndpoint: id => `/academic-sessions/${encodeURIComponent(id)}`,
        columns: [
            ['Name', entity => entityLinkValue('academicSession', entity)],
            ['Code', entity => codeValue(entity.primaryCode)],
    ...
    programs: {
        ...
        offeringsEndpoint: id => `/programs/${encodeURIComponent(id)}/offerings`,
        columns: [
    ...
    courses: {
        ...
        offeringsEndpoint: id => `/courses/${encodeURIComponent(id)}/offerings`,
        columns: [
...
Constants.enumOptions = {
    ...
    codeType: [
        ...
        ['uuid', 'UUID'],
        ['brin', 'BRIN'],
        ['crohoCreboCode', 'CROHO/Crebo code'],
